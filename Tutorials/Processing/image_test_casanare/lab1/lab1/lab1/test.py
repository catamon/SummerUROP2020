...
class TestImage(Lab1Test):
    def test_load_color(self):
        result = lab.load_color_image('lab1/lab1/test_images/centered_pixel.png')
        expected = {
            'height': 11,
            'width': 11,
...
class TestColorFilters(Lab1Test):
    def test_color_filter_inverted(self):
        im = lab.load_color_image('lab1/lab1/test_images/centered_pixel.png')
...
def load_greyscale_image(filename):
    ...
    Invoked as, for example:
       i = load_image('lab1/lab1/test_images/cat.png')
    """
