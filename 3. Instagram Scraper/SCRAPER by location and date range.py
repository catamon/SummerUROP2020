...
- So far I have collected data from Colegio Anglo Colombiano and The Number Six Club. This are locations with small amount of posts.

- I still need to figure out how to differenciate image vs video and save videos. (Do I need to save videos?)

- Images are been saved in .png format

- Currently the csv file only has account, location, date, url. But we can access caption, comments, likes, and more information
of posts with the json-ld script.
'''
